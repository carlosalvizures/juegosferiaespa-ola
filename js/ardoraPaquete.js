...
taboaContidos[0]=new act("1","1","","<object width='100%' height='420' type='text/html' data='ABCDE/ABCDE.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("2","2","","<object width='100%' height='420' type='text/html' data='capitales_lite/capitales_lite.htm'></object>",false,"",true,true,true);
taboaContidos[2]=new act("3","3","","<object width='100%' height='420' type='text/html' data='CE/CE.htm'></object>",false,"",true,true,true);
taboaContidos[3]=new act("4","4","","<object width='100%' height='420' type='text/html' data='Crucigrama/Crucigrama.htm'></object>",false,"",true,true,true);
